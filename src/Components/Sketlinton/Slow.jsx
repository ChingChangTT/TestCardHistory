...
export default function SlowCard() {
  return (
    <div>
      <>
        {/* component */}
        <section className="bg-white dark:bg-gray-900 w-4/5 m-auto">
          <div className="container px-6 py-10 mx-auto animate-pulse">
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 sm:grid-cols-1 xl:grid-cols-3 lg:grid-cols-2">
